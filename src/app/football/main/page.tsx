		...
		<section className="flex flex-col justify-center gap-[50px] md:gap-[80px] items-center pt-[22px]">
			...
			<div>
				...
				<div className='lg:flex lg:justify-start lg:items-center lg:mb-5'>
					...
					<p className='mb-[14px] md:mb-6 lg:mb-0 text-center font-display text-sm md:text-lg font-semibold md:font-normal leading-[150%] md:leading-[100%]'>Голосіївский район, вул. Героїв Маріуполя 7а</p>
				</div>
