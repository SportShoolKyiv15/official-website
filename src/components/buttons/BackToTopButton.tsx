...
const BackToTopButton: React.FC = () => {
	...
	return (
		<button
			className={`fixed flex items-center justify-center right-1/2 translate-x-1/2 bottom-5 bg-back-top border-2 border-white text-white rounded-full md:hover:scale-105 transition-all text-center w-12 h-12 text-3xl ${isVisible ? "opacity-100" : "opacity-0"
				} sm:w-16 sm:h-16 sm:text-2xl md:w-16 lg:w-20 md:h-16 lg:h-20 md:text-3xl lg:w-24 lg:h-24 lg:text-4xl z-100`}
			onClick={scrollToTop}
		>
